...
/**
 * Bean definitions for {@link StateRepository}.
 */
@Generated
public class StateRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'stateRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getStateRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'stateRepository'.
   */
  public static BeanDefinition getStateRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, StateRepository.class, State.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.tourism.repository.StateRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.StateRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.tourism.repository.StateRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getStateRepositoryInstanceSupplier();

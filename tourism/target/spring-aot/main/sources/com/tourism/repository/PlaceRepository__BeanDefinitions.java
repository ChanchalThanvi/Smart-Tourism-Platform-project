...
/**
 * Bean definitions for {@link PlaceRepository}.
 */
@Generated
public class PlaceRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'placeRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getPlaceRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'placeRepository'.
   */
  public static BeanDefinition getPlaceRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, PlaceRepository.class, Place.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.tourism.repository.PlaceRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.PlaceRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.tourism.repository.PlaceRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getPlaceRepositoryInstanceSupplier();

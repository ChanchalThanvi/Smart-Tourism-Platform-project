 ...
 */
@Generated
public class TourismApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TourismApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TourismApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
